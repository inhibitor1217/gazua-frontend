    ...
    return (
        <div className={cx('abbr-info-panel')}>
            <div className={cx('abbr-info-panel-horizontal')}>
                <AbbrInfoBox dark data={data['btc_krw']}/>
                <AbbrInfoBox dark data={data['etc_krw']}/>
                <AbbrInfoBox dark data={data['eth_krw']}/>
            </div>
            <div className={cx('abbr-info-panel-horizontal')}>
                <AbbrInfoBox dark data={data['xrp_krw']}/>
                <AbbrInfoBox dark data={data['bch_krw']}/>
                <AbbrInfoBox dark data={data['ltc_krw']}/>
            </div>
        </div>
    );
};
